...
--
-- Class PdfContent as table pdf_content
--
...
--
-- Class SchemaDefinition as table schema_definitions
--
...
--
-- Class ShoebillTemplateBaselineImplementation as table shoebill_template_baseline_implementations
--
...
--
-- Class ShoebillTemplateBaseline as table shoebill_template_baselines
--
...
--
-- Class ShoebillTemplateScaffold as table shoebill_template_scaffolds
--
...
--
-- Class ShoebillTemplateVersionInput as table shoebill_template_version_inputs
--
...
--
-- Class ShoebillTemplateVersion as table shoebill_template_versions
--
...
--
-- Foreign relations for "shoebill_template_baseline_implementations" table
--
...
--
-- Foreign relations for "shoebill_template_baselines" table
--
...
--
-- Foreign relations for "shoebill_template_scaffolds" table
--
...
--
-- Foreign relations for "shoebill_template_versions" table
--
...
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('shoebill_template', '20260216133330696', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20260216133330696', "timestamp" = now();
