...
import 'package:shoebill_template_server/src/generated/api/chat_session_related/entities/template_current_state/template_current_state.dart'
    as _i4;
import 'package:shoebill_template_server/src/generated/api/chat_session_related/entities/send_message_stream_response_item.dart'
    as _i5;
import 'package:shoebill_template_server/src/generated/api/chat_session_related/entities/new_schema_change_payload.dart'
    as _i6;
import 'package:shoebill_template_server/src/generated/api/chat_session_related/entities/create_template_essentials_result.dart'
    as _i7;
...
class _ChatSessionEndpoint {
  ...
  _i3.Future<_i3.Stream<_i5.SendMessageStreamResponseItem>> sendMessage(
    _i1.TestSessionBuilder sessionBuilder, {
    required String sessionUUID,
    required String message,
    _i6.NewSchemaChangePayload? schemaChange,
  }) async {
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      var _localUniqueSession =
          (sessionBuilder as _i1.InternalTestSessionBuilder).internalBuild(
      ...
      try {
        ...
        var _localReturnValue =
            await (_localCallContext.method.call(
                ...
                as _i3.Future<_i3.Stream<_i5.SendMessageStreamResponseItem>>);
        return _localReturnValue;
      } finally {
        await _localUniqueSession.close();
      }
...
class _CreateTemplateEssentialsEndpoint {
  ...
  _i3.Stream<_i7.CreateTemplateEssentialsResult> call(
    _i1.TestSessionBuilder sessionBuilder, {
    required String stringifiedPayload,
  }) {
    var _localTestStreamManager =
        _i1.TestStreamManager<_i7.CreateTemplateEssentialsResult>();
    _i1.callStreamFunctionAndHandleExceptions(
      () async {
        var _localUniqueSession =
            (sessionBuilder as _i1.InternalTestSessionBuilder).internalBuild(
              endpoint: 'createTemplateEssentials',
              method: 'call',
            );
        var _localCallContext = await _endpointDispatch
            .getMethodStreamCallContext(
              createSessionCallback: (_) => _localUniqueSession,
              endpointPath: 'createTemplateEssentials',
              methodName: 'call',
              arguments: {'stringifiedPayload': stringifiedPayload},
